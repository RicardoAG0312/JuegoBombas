...
var gameOver = false;
//Funciones
function preload(){ //Funcion para crear imagenes del juego
...
function create(){ //Funcion para cargar las imagenes
    this.add.image(400, 300, "sky");
    platforms = this.physics.add.staticGroup();
    platforms.create(400, 568, "ground").setScale(2).refreshBody();
    platforms.create(640, 350, "ground");
    platforms.create(50, 250, "ground");
    platforms.create(740, 180, "ground");
